...
public class MainKlasa {
    public static void main(String[] args) {
        //OOP17 - Napraviti paket "KlaseRadnik" i dve klase - "Radnik" i "MainKlasa". U klasi Radnik deklarisati public atribute jmbg (tipa long), ime i prezime (jedan string), broj dece, stepen strucne spreme i radni staz.
