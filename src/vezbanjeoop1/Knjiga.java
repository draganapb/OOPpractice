package vezbanjeoop1;

public class Knjiga {//Napraviti klasu Knjiga koja ce imati naziv i zanr.
    ...
    public void provera(Knjiga n1, Knjiga n2){
        if(n1.naziv.equalsIgnoreCase(n2.naziv)){
